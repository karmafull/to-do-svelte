...
var app = (function () {
    ...
    // (39:6) {#each todoItems as todo (todo.id)}
    function create_each_block(key_1, ctx) {
    	...
    	return {
    		...
    		c: function create() {
    			...
    			add_location(input, file, 40, 10, 889);
    			attr(label, "for", label_for_value = ctx.todo.id);
    			attr(label, "class", "tick");
    			add_location(label, file, 41, 10, 938);
    			add_location(span, file, 42, 10, 1028);
    			attr(use, "href", "#delete-icon");
    			add_location(use, file, 44, 17, 1146);
    			add_location(svg, file, 44, 12, 1141);
    			attr(button, "class", "delete-todo");
    			add_location(button, file, 43, 10, 1063);
    			attr(li, "class", li_class_value = "todo-item " + (ctx.todo.checked ? 'done' : ''));
    			add_location(li, file, 39, 8, 827);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t3 = space();
    			h2 = element("h2");
    			h2.textContent = "Add to-do task down below";
    			t5 = space();
    			p = element("p");
    			p.textContent = " ↓↓↓↓↓↓↓↓↓↓↓ ";
    			t7 = space();
    			...
    			add_location(h1, file, 36, 4, 717);
    			attr(ul, "class", "todo-list");
    			add_location(ul, file, 37, 4, 754);
    			attr(use, "href", "#checklist-icon");
    			add_location(use, file, 50, 34, 1306);
    			attr(svg, "class", "checklist-icon");
    			add_location(svg, file, 50, 6, 1278);
    			attr(h2, "class", "empty-state__title");
    			add_location(h2, file, 51, 6, 1353);
    			attr(p, "class", "empty-state__description");
    			add_location(p, file, 52, 6, 1415);
    			attr(div0, "class", "empty-state");
    			add_location(div0, file, 49, 4, 1246);
    			attr(input, "class", "js-todo-input");
    			attr(input, "type", "text");
    			attr(input, "aria-label", "Enter a new todo item");
    			attr(input, "placeholder", "Enter text here");
    			add_location(input, file, 55, 6, 1554);
    			add_location(form, file, 54, 4, 1506);
    			attr(div1, "class", "container");
    			add_location(div1, file, 35, 2, 689);
    			add_location(main, file, 34, 0, 680);
